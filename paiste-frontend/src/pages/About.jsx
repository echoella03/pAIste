...
export default function About() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'white' }}>
      ...
      <nav className="navbar-dark px-8 py-3 flex items-center justify-between flex-shrink-0">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <section className="rounded-2xl p-8 shadow-sm" style={{ backgroundColor: '#FAFAF4' }}>
          ...
          {/* Second Row: Thesis Adviser (Centered Below) */}
          <div className="flex justify-center mt-12">
            <div className="flex flex-col items-center text-center max-w-xs">
                ...
                <p className="font-londrina text-xs tracking-widest mt-1" style={{ color: '#466958' }}>{team[3].role}</p>
